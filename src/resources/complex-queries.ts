...
export class ComplexQueries extends APIResource {
  arrayQuery(query?: ComplexQueryArrayQueryParams, options?: Core.RequestOptions): Core.APIPromise<ComplexQueryArrayQueryResponse>
  arrayQuery(options?: Core.RequestOptions): Core.APIPromise<ComplexQueryArrayQueryResponse>
  arrayQuery(query: ComplexQueryArrayQueryParams | Core.RequestOptions = {}, options?: Core.RequestOptions): Core.APIPromise<ComplexQueryArrayQueryResponse> {
  ...
  objectQuery(query?: ComplexQueryObjectQueryParams, options?: Core.RequestOptions): Core.APIPromise<ComplexQueryObjectQueryResponse>
  objectQuery(options?: Core.RequestOptions): Core.APIPromise<ComplexQueryObjectQueryResponse>
  objectQuery(query: ComplexQueryObjectQueryParams | Core.RequestOptions = {}, options?: Core.RequestOptions): Core.APIPromise<ComplexQueryObjectQueryResponse> {
    if (isRequestOptions(query)) {
  ...
  unionQuery(query?: ComplexQueryUnionQueryParams, options?: Core.RequestOptions): Core.APIPromise<ComplexQueryUnionQueryResponse>
  unionQuery(options?: Core.RequestOptions): Core.APIPromise<ComplexQueryUnionQueryResponse>
  unionQuery(query: ComplexQueryUnionQueryParams | Core.RequestOptions = {}, options?: Core.RequestOptions): Core.APIPromise<ComplexQueryUnionQueryResponse> {
    if (isRequestOptions(query)) {
