...
export class Sink extends Core.APIClient {
  ...
  constructor(config: Config) {
    ...
    if (!username) {
      throw new Error("The SINK_USER environment variable is missing or empty; either provide it, or instantiate the Sink client with an username option, like new Sink({ username: 'Robert' }).");
    }
