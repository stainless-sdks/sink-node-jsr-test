...
describe('resource child', () => {
  test('retrieve', async () => {
    const responsePromise = client.modelReferencedInParentAndChild.child.retrieve();
  ...
  test('retrieve: request options instead of params are passed correctly', async () => {
    ...
    await expect(client.modelReferencedInParentAndChild.child.retrieve({ path: '/_stainless_unknown_path' }))
      .rejects
