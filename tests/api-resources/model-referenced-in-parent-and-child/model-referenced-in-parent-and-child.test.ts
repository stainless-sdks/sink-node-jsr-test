...
describe('resource modelReferencedInParentAndChild', () => {
  test('retrieve', async () => {
    const responsePromise = client.modelReferencedInParentAndChild.retrieve();
  ...
  test('retrieve: request options instead of params are passed correctly', async () => {
    ...
    await expect(client.modelReferencedInParentAndChild.retrieve({ path: '/_stainless_unknown_path' }))
      .rejects
