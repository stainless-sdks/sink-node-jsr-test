...
describe('resource levelOne', () => {
  test('methodLevel1', async () => {
    const responsePromise = client.deeplyNested.levelOne.methodLevel1('182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e');
  ...
  test('methodLevel1: request options instead of params are passed correctly', async () => {
    ...
    await expect(client.deeplyNested.levelOne.methodLevel1('182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e', { path: '/_stainless_unknown_path' }))
      .rejects
