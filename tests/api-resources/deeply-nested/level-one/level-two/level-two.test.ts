...
describe('resource levelTwo', () => {
  test('methodLevel2', async () => {
    const responsePromise = client.deeplyNested.levelOne.levelTwo.methodLevel2('182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e');
  ...
  test('methodLevel2: request options instead of params are passed correctly', async () => {
    ...
    await expect(client.deeplyNested.levelOne.levelTwo.methodLevel2('182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e', { path: '/_stainless_unknown_path' }))
      .rejects
