...
describe('resource clients', () => {
  test('create: only required params', async () => {
    const responsePromise = client.clients.create({ account_token: '182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e', name: 'name' });
  ...
  test('create: required and optional params', async () => {
    const response = await client.clients.create({ account_token: '182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e', name: 'name' });
  });
});
