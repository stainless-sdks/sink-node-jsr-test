...
describe('resource unions', () => {
  test('arrayParamDiscriminatedByPropertyName: only required params', async () => {
    const responsePromise = client.types.unions.arrayParamDiscriminatedByPropertyName([
      { value: 'value' },
      { value: 'value' },
      { value: 'value' },
    ]);
  ...
  test('arrayParamDiscriminatedByPropertyName: required and optional params', async () => {
    const response = await client.types.unions.arrayParamDiscriminatedByPropertyName([
      { value: 'value', type: 'a' },
      { value: 'value', type: 'a' },
      { value: 'value', type: 'a' },
    ]);
  ...
  test('arrayParamDiscriminatedWithBasicMapping: only required params', async () => {
    const responsePromise = client.types.unions.arrayParamDiscriminatedWithBasicMapping([
      { value: 'value' },
      { value: 'value' },
      { value: 'value' },
    ]);
  ...
  test('arrayParamDiscriminatedWithBasicMapping: required and optional params', async () => {
    const response = await client.types.unions.arrayParamDiscriminatedWithBasicMapping([
      { value: 'value', type: 'a' },
      { value: 'value', type: 'a' },
      { value: 'value', type: 'a' },
    ]);
  ...
  test('paramDiscriminatedByPropertyName: required and optional params', async () => {
    const response = await client.types.unions.paramDiscriminatedByPropertyName({
      value: 'value',
      type: 'a',
    });
  });
  ...
  test('paramDiscriminatedWithBasicMapping: required and optional params', async () => {
    const response = await client.types.unions.paramDiscriminatedWithBasicMapping({
      value: 'value',
      type: 'a',
    });
  });
  ...
  test('responseDiscriminatedByPropertyName: request options instead of params are passed correctly', async () => {
    ...
    await expect(
      client.types.unions.responseDiscriminatedByPropertyName({ path: '/_stainless_unknown_path' }),
  ...
  test('responseDiscriminatedWithBasicMapping: request options instead of params are passed correctly', async () => {
    // ensure the request options are being passed correctly by passing an invalid HTTP method in order to cause an error
    await expect(
      client.types.unions.responseDiscriminatedWithBasicMapping({ path: '/_stainless_unknown_path' }),
    ).rejects.toThrow(Sink.NotFoundError);
  });
});
