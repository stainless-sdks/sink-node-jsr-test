...
describe('resource emptyBody', () => {
  ...
  test('stainlessEmptyObject: required and optional params', async () => {
    const response = await client.emptyBody.stainlessEmptyObject('path_param', { body: {}, query_param: 'query_param', second_query_param: 'second_query_param' });
  });
  ...
  test('typedParams: required and optional params', async () => {
    const response = await client.emptyBody.typedParams('path_param', { body: {}, query_param: 'query_param', second_query_param: 'second_query_param' });
  });
});
