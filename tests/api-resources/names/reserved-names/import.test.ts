...
describe('resource import', () => {
  test('import', async () => {
    const responsePromise = client.names.reservedNames.import.import();
  ...
  test('import: request options instead of params are passed correctly', async () => {
    // ensure the request options are being passed correctly by passing an invalid HTTP method in order to cause an error
    await expect(client.names.reservedNames.import.import({ path: '/_stainless_unknown_path' }))
      .rejects
