...
export class Responses extends APIResource {
   ...
   */
  additionalProperties(options?: Core.RequestOptions): Promise<Core.APIResponse<ResponseAdditionalPropertiesResponse>>{
   ...
   */
  additionalPropertiesNestedModelReference(options?: Core.RequestOptions): Promise<Core.APIResponse<ResponseAdditionalPropertiesNestedModelReferenceResponse>>{
   ...
   * Endpoint with an empty response.
   */
  objectNoProperties(options?: Core.RequestOptions): Promise<Core.APIResponse<ResponseObjectNoPropertiesResponse>>{
  ...
  stringResponse(options?: Core.RequestOptions): Promise<Core.APIResponse<Promise<string>>>{
    return this.post('/responses/string', { ...options, headers: { Accept: 'application/json', ...options?.headers } })
  };
}
