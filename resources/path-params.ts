...
export class PathParams extends APIResource {
   ...
   */
  multiple(first: string, second: string, last: string, options?: Core.RequestOptions): Promise<Core.APIResponse<PathParamMultipleResponse>>{
   ...
   */
  singular(singular: string, options?: Core.RequestOptions): Promise<Core.APIResponse<PathParamSingularResponse>>{
