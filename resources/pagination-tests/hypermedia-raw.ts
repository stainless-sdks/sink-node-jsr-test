...
export class HypermediaRaw extends APIResource {
   ...
   */
  list(query?: HypermediaRawListParams, options?: Core.RequestOptions): Core.PagePromise<MyModelsPageHypermediaRaw>;
  list(options?: Core.RequestOptions): Core.PagePromise<MyModelsPageHypermediaRaw>;
  list(query: HypermediaRawListParams | Core.RequestOptions = {}, options?: Core.RequestOptions): Core.PagePromise<MyModelsPageHypermediaRaw>{
