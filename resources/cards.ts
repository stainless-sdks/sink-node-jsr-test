...
export class Cards extends APIResource {
   ...
   * undone._
   */
  update(cardToken: string, body: CardUpdateParams, options?: Core.RequestOptions): Promise<Core.APIResponse<Card>>{
   ...
   */
  provisionFoo(cardToken: string, body: CardProvisionFooParams, options?: Core.RequestOptions): Promise<Core.APIResponse<CardProvisionFooResponse>>{
   ...
   */
  reissue(cardToken: string, body: CardReissueParams, options?: Core.RequestOptions): Promise<Core.APIResponse<Card>>{
...
export namespace Card {export interface Funding  {
  /**
...
export namespace CardCreateParams {export interface ShippingAddress  {
  /**
...
export namespace CardReissueParams {export interface ShippingAddress  {
  /**
 * Valid USPS routable address.
 */
address1: string
