...
export class Sta_569Resource extends APIResource {
   ...
   */
  oneEntry(body: Sta_569OneEntryParams, options?: Core.RequestOptions): Promise<Core.APIResponse<Sta_569OneEntryResponse>>{
   ...
   * See https://linear.app/stainless/issue/STA-569/support-for-type-[object-null]
   */
  oneEntryWithNull(body?: Sta_569OneEntryWithNullParams, options?: Core.RequestOptions): Promise<Core.APIResponse<Sta_569OneEntryWithNullResponse | null>>;
  oneEntryWithNull(options?: Core.RequestOptions): Promise<Core.APIResponse<Sta_569OneEntryWithNullResponse | null>>;
  oneEntryWithNull(body: Sta_569OneEntryWithNullParams | Core.RequestOptions = {}, options?: Core.RequestOptions): Promise<Core.APIResponse<Sta_569OneEntryWithNullResponse | null>>{
